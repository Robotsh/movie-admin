...
<title>登录页面 - myMovie后台管理系统</title>
    ...
    <div class="login-center">
      ...
      <form action="#!" method="post">
        ...
        <div class="form-group has-feedback feedback-left row">
          ...
          <div class="col-xs-5">
            <img src="${basePath}/static/images/captcha.png" class="pull-right" id="captcha" style="cursor: pointer;" onclick="this.src=this.src+'?d='+Math.random();" title="点击刷新" alt="captcha">
          </div>
        </div>
